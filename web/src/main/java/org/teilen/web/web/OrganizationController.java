...
public class OrganizationController {
    ...
    public String saveDetails(@ModelAttribute User user, @ModelAttribute PasswordModel passwordModel,
                              @ModelAttribute("userAddress") UserAddress userAddress, @ModelAttribute("userContact") UserContact userContact,
        ...
        if (passwordModel.getPassword().equals(passwordModel.getRePassword())) {
            ...
            try {
                ...
                User tmp = signService.signUp(user, userContact, userAddress, passwordModel, countryId, organization);
