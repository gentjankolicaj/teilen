...
class UserRestController {
    ...
    public List<User> getUserByFirstNameLike(@RequestParam("firstname") String firstName) throws Exception {
    ...
    public List<User> getUserByLastNameLike(@RequestParam("lastname") String lastName) throws Exception {
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    @RequestMapping(params = {"username_like"}, method = RequestMethod.GET, produces = "application/json")
    public List<User> getUserByUsernameLike(@RequestParam("username_like") String usernameLike) throws Exception {
