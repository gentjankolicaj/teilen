...
class UserAdressRestController {
    ...
    public List<UserAddress> getUserAdressesByStreetLike(@RequestParam("street") String street) throws Exception {
    ...
    public List<UserAddress> getUserAdressesByCity(@RequestParam("city") String city) throws Exception {
    ...
    public List<UserAddress> getUserAdressesByCountryId(@RequestParam("countryId") String countryId) throws Exception {
    ...
    public UserAddress editUserAdress(@PathVariable("id") String id, @RequestBody UserAddress userAddress)
            throws Exception {
        if (NumberUtils.isParsable(id)) {
            Long userAdressId = Long.parseLong(id);
            if (userAddress == null)
