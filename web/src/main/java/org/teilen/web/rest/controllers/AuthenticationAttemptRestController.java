...
class AuthenticationAttemptRestController {  //controller classes are private package because aren't going to be used outside package
    ...
    @Autowired
    public AuthenticationAttemptRestController(AuthenticationAttemptService authenticationAttemptService) {
        super();
    ...
    public ResponseEntity<Object> unMappedRequests() {
        return new ResponseEntity<>("Wrong URI or wrong request method", new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
