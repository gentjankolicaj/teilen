...
public class AuthenticationAttemptServiceImpl implements AuthenticationAttemptService {
    ...
    @Override
    public List<AuthenticationAttempt> createAll(List<AuthenticationAttempt> entities) throws Exception {
    ...
    @Override
    public List<AuthenticationAttempt> editAll(List<AuthenticationAttempt> entities) throws Exception {
