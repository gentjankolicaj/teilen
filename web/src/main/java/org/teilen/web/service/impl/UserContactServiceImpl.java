...
public class UserContactServiceImpl implements UserContactService {
    ...
    @Override
    public UserContact createContact(User user, String email, Long telephone, Long mobile, String postalCode)
            throws Exception {
    ...
    @Override
    public UserContact editContact(Long contactId, String email, Long telephone, Long mobile, String postalCode)
            throws Exception {
