...
public class UserAdressServiceImpl implements UserAdressService {
    ...
    @Override
    public UserAddress createAdress(User user, String street, String city, Country country) throws Exception {
    ...
    @Override
    public UserAddress editAdress(Long adressId, String street, String city, Country country) throws Exception {
    ...
    @Override
    public UserAddress editAdress(UserAddress userAddress, String street, String city, Country country) throws Exception {
        if (userAddress == null)
