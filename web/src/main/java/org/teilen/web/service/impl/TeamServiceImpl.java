...
public class TeamServiceImpl implements TeamService {
    ...
    @Override
    public Team createTeam(User creator, Department department, String name, String description) throws Exception {
        Team team = new Team();
    ...
    @Override
    public Team editTeam(Team team, User creator, Department department, String name, String description)
            throws Exception {
        if (team == null)
            throw new TeamException("Team dosen't exist.Reference is null.");
    ...
    @Override
    public Team editTeam(Long teamId, User creator, Department department, String name, String description)
            throws Exception {
        Team tmp = teamDao.findById(teamId);
        if (tmp == null)
            throw new TeamException("Team dosen't exist.Reference is null.");
