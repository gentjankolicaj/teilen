...
public class AuthenticationAttemptDaoImpl implements AuthenticationAttemptDao {
    ...
    @Override
    public AuthenticationAttempt update(AuthenticationAttempt authenticationAttempt) throws Exception {
        Session session = sessionFactory.getCurrentSession();
    ...
    @Override
    public List<AuthenticationAttempt> saveAll(List<AuthenticationAttempt> entities) throws Exception {
        Session session = sessionFactory.getCurrentSession();
    ...
    @Override
    public List<AuthenticationAttempt> updateAll(List<AuthenticationAttempt> entities) throws Exception {
        Session session = sessionFactory.getCurrentSession();
        for (AuthenticationAttempt tmp : entities) {
